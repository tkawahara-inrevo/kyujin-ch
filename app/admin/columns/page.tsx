...
import { deleteColumnPost } from "@/app/actions/admin/columns";
    ...
    <div className="p-6 lg:p-10">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Link href="/admin/columns/templates" className="rounded-lg border border-[#d1d5db] px-4 py-2.5 text-[13px] font-bold text-[#4b5565] hover:bg-[#f8fafc]">
            テンプレート管理
          </Link>
          <Link href="/admin/columns/new" className="rounded-lg bg-[#2f6cff] px-4 py-2.5 text-[13px] font-bold text-white hover:opacity-90">
            新規作成
          </Link>
        </div>
      </div>
                  ...
                  <tr key={post.id} className="border-b border-[#eef2f8] last:border-b-0">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-2">
                        <Link href={`/admin/columns/${post.id}/edit`}
