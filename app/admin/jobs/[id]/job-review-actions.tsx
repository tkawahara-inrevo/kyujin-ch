...
export function JobReviewActions({
  ...
  if (done === "returned") {
    return (
      <p className="mt-4 text-[15px] font-bold text-[#c2410c]">差し戻し済み。</p>
    );
  }

  if (done === "approved") {
    return (
      <p className="mt-4 text-[15px] font-bold text-[#16a34a]">承認して公開済み。</p>
    );
  }
  ...
  return (
    <>
      <textarea
        ...
        className="mt-4 w-full rounded-lg border border-[#ddd] px-3 py-2 text-[13px] outline-none focus:border-[#2f6cff]"
      />
