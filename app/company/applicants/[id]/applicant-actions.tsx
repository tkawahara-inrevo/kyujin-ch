...
} from "@/app/actions/company/applicants";
...
export function ApplicantActions({
  ...
  function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (!ALLOWED_TYPES.includes(nextFile.type)) {
      setFileError("対応形式は PDF / DOCX / XLSX のみです");
      e.target.value = "";
      return;
    }
  ...
  const currentStatusLabel =
    STATUSES.find((status) => status.value === currentStatus)?.label ?? currentStatus;
                ...
                return (
                  ...
                  >
                    <div className="max-w-[85%] md:max-w-[75%]">
                      ...
                      <p
                        className={`mt-0.5 text-[10px] text-[#bbb] ${
