    ...
    <form onSubmit={handleSubmit} className="mt-6 max-w-[720px] space-y-8">
      ...
      <Section title="基本情報">
        ...
        <Field label="メイン画像URL">
          <input name="imageUrl" defaultValue={job.imageUrl ?? ""} className={inputCls} placeholder="https://..." />
        </Field>

        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="求人カテゴリ">
            <select name="categoryTag" defaultValue={job.categoryTag ?? ""} className={inputCls}>
