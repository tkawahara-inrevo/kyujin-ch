      ...
      >
        ...
        >
          ...
          <Section title="仕事内容">
            ...
            <Field label="向いている人">
              <textarea name="desiredAptitude" rows={3} defaultValue={job.desiredAptitude ?? ""} className={textareaCls} placeholder="例：主体的に動ける方、新しいことに挑戦することが好きな方、チームワークを大切にできる方" />
            </Field>
            <Field label="おすすめの人">
              <textarea name="recommendedFor" rows={3} defaultValue={job.recommendedFor ?? ""} className={textareaCls} placeholder="例：キャリアアップを目指したい方、安定した環境で長く働きたい方、副業・複業に興味のある方" />
            </Field>
          </Section>
          ...
          <Section title="勤務条件">
            <Field label="勤務時間">
              <input name="workingHours" defaultValue={job.workingHours ?? ""} className={inputCls} placeholder="例：9:00〜18:00（休憩60分）／フレックスタイム制（コアタイム10:00〜15:00）" />
            </Field>
            <Field label="雇用期間">
              <select
          ...
          <Section title="募集背景・ポジション">
            ...
            <Field label="ポジションの役割">
              <textarea
                ...
                rows={3}
                defaultValue={job.positionMission ?? ""}
                className={textareaCls}
          ...
          <Section title="条件詳細">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Field label="固定残業代">
                <input
                  name="fixedOvertime"
                  defaultValue={job.fixedOvertime ?? ""}
                  className={inputCls}
            ...
            <Field label="昇給・賞与">
              <input
                name="salaryRevision"
                defaultValue={job.salaryRevision ?? ""}
                className={inputCls}
          ...
          <Section title="選考・入社時期">
            <div className="grid gap-4 md:grid-cols-3">
              <Field label="面接回数・方法">
                <input
                  name="interviewCount"
                  defaultValue={job.interviewCount ?? ""}
                  className={inputCls}
              ...
              <Field label="選考期間の目安">
                <input
                  ...
                  defaultValue={job.selectionDuration ?? ""}
                  className={inputCls}
