...
export default async function CompanyJobsPage({
  ...
  const rows = jobs.map((job) => ({
    ...
    previewData: {
      ...
      categoryTagDetail: job.categoryTagDetail ?? undefined,
      employmentType: job.employmentType,
      employmentTypeDetail: job.employmentTypeDetail ?? undefined,
      location: job.location ?? undefined,
      region: job.region ?? undefined,
      officeDetail: job.officeDetail ?? undefined,
      salaryMin: job.salaryMin ? String(Math.round(job.salaryMin / 10000)) : undefined,
      salaryMax: job.salaryMax ? String(Math.round(job.salaryMax / 10000)) : undefined,
      tags: job.tags,
      benefits: job.benefits,
      targetType: job.targetType ?? undefined,
